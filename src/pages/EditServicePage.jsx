  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-10 animate-fade-in font-sans">
      <div className="flex items-center gap-6">
        ...
        <div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tighter uppercase">Modify Service Protocol</h1>
          <p className="text-slate-500 font-bold uppercase text-[10px] tracking-[0.2em] mt-1">Adjusting: {service.name}</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[40px] shadow-premium border border-slate-50 overflow-hidden">
        <div className="p-10 space-y-8">
           <div className="space-y-4">
              ...
              <input 
                 type="text" 
                 className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-3xl text-sm font-bold text-slate-700 outline-none focus:ring-4 focus:ring-clinicPrimary/10 focus:border-clinicPrimary transition-all"
                 value={service.name}
        ...
        <div className="px-10 py-8 bg-slate-50/50 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-6">
           ...
           <div className="flex gap-4 w-full md:w-auto">
              <Button variant="secondary" className="flex-1 md:px-10 py-5 rounded-2xl" onClick={() => navigate('/billing/pricing')}>Cancel Adjustments</Button>
              <Button variant="accent" className="flex-1 md:px-10 py-5 rounded-2xl" onClick={handleUpdate} leftIcon={<FaRedo />}>Update Protocol</Button>
           </div>
        </div>
      </div>
    </div>
