  ...
  return (
    <aside className={cn(
      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-3 bg-white/5 p-3 rounded-xl border border-white/5 hover:bg-white/10 transition-all cursor-pointer group">
          <div className={`w-10 h-10 rounded-full bg-gradient-to-br ${currentProfile.color} flex items-center justify-center font-bold text-white shadow-lg group-hover:scale-110 transition-all duration-300`}>
            {currentProfile.initial}
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-xs font-bold truncate text-white uppercase tracking-tight">{currentProfile.name}</p>
